...
To create a Google Earth / Palantir-style 3D macro grid, we will use **CesiumJS**, an open-source JavaScript library for world-class 3D globes and maps.
...
*   **UI:** A sleek, dark, glassmorphism UI overlay (Palantir style) using vanilla CSS, showing connection status, fleet health, and interactive controls to trigger demand spikes.
