"""
Drone Flyover Target Detection — Straight-line pass at 150m altitude, 70kph

The drone flies a straight-line surveillance pass over the target:
  1. Starts 500m in front of target at 150m altitude
...
RENDER_W = 640
RENDER_H = 480
DRONE_ALTITUDE = 15000.0     # cm = 150m
...
async def flyover_loop():
    ...
    print("=" * 55)
    print("  DRONE FLYOVER — 70kph @ 150m")
