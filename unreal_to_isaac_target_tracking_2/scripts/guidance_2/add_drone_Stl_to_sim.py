...
# Import STL
stl_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "guidance", "Fixed V2 for Print.stl")
...
async def import_drone():
    # Convert STL to USD
    usd_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "guidance", "drone_model.usd")
