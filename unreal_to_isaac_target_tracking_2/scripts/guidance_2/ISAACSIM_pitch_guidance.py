...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "output_guidance")
...
async def guidance_loop():
    ...
    tracking = False
    error_y = 0
    CAPTURE_INTERVAL = 1  # Capture every frame — smoother but slower
