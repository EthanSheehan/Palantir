"""Tests for PalantirSettings magic constants — W6-037."""

import pytest
from config import PalantirSettings

# Env vars that PalantirSettings reads — must be cleaned before each test
...
def _clean_settings_env(monkeypatch):
    """Remove all PalantirSettings env vars so defaults are tested cleanly."""
