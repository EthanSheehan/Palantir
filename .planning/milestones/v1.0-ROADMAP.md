# Grid-Sentinel Swarm Upgrade — Roadmap
...
- [ ] 00-07-PLAN.md — ECharts dark theme, grid_sentinel.sh launcher update, final integration checkpoint
...
src/frontend-react/
  ...
  src/
    ...
    theme/
      grid_sentinel.ts                         # ECharts dark theme matching Blueprint
```
...
- Create base chart theme matching Blueprint dark + Grid-Sentinel style
...
- [ ] `./grid_sentinel.sh` updated to use Vite build
...
| `src/frontend/src/theme/grid_sentinel.ts` | **NEW** | ECharts dark theme |
...
| `grid_sentinel.sh` | MODIFY | Update to use Vite build |
