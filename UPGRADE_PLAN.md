# Palantir Swarm Sensor Fusion Upgrade Plan

> Staged upgrade roadmap for drone swarm sensor fusion, intelligent target management, and battlespace assessment. Each stage is independently demoable via `./palantir.sh --demo`.
...
Run `./palantir.sh --demo` and verify:
...
Run `./palantir.sh --demo` and verify the complete loop:
