# Contributing to Grid-Sentinel C2

**Last Updated: 2026-03-19**

This guide covers development setup, testing, code style, and the PR process for Grid-Sentinel.
...
git clone https://github.com/EthanSheehan/Grid-Sentinel.git
cd Grid-Sentinel
...
|---------|---------|------|
| `./grid-sentinel.sh` | Launch complete system (backend + frontend + simulator) | FastAPI (:8000) + HTTP Server (:3000) + Simulator |
| `./grid-sentinel.sh --demo` | Launch in demo auto-pilot mode (full F2T2EA kill chain) | All components + auto-approvals |
| `./grid-sentinel.sh --demo --no-sim` | Demo mode without drone video simulator | Backend + frontend only |
...
- **Coding Standards**: [Coding Style Rules](https://github.com/EthanSheehan/Grid-Sentinel/blob/main/.claude/rules/coding-style.md)
- **Testing Guide**: [Testing Requirements](https://github.com/EthanSheehan/Grid-Sentinel/blob/main/.claude/rules/testing.md)
- **Git Workflow**: [Git Workflow](https://github.com/EthanSheehan/Grid-Sentinel/blob/main/.claude/rules/git-workflow.md)
