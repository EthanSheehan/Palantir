# PRD v2: Palantir C2 — Full System Upgrade
...
Palantir C2 v1 delivered a working proof-of-concept: 10Hz simulation loop, Cesium 3D visualization, dual-client WebSocket architecture, and a skeleton multi-agent kill chain. The system has a solid foundation but critical gaps prevent it from being a convincing military demo:
...
| Deployment | `palantir.sh` launcher | Keep it simple; Docker optional later |
